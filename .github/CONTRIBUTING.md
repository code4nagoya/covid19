...
開発責任者をしています、Code for Nagoyaの宮内です。何か質問があれば、Slack などでお気軽に質問してください！
...
ご協力いただいた皆様のお名前（ハンドルネーム）や役割を記す、[CONTRIBUTORS.md](https://github.com/code4nagoya/covid19/blob/development/CONTRIBUTORS.md) というファイルがあります。
